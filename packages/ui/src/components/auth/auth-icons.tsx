...
/**
 * Google "G" logo icon — 4-color brand version
 * Extracted from forum sign-in form for cross-app reuse
 */
...
/**
 * Loading spinner icon — animated circular spinner
 * Extracted from forum sign-in form for cross-app reuse
 */
