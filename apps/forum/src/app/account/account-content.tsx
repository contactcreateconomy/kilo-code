...
const navItems = [
  ...
  { href: "/account/saved", label: "Saved", icon: "🔖" },
  { href: "/account/security", label: "Security", icon: "🔒" },
  { href: "/account/flair", label: "Flair", icon: "🏷️" },
];

/**
 * AccountContent — Client component that wraps the account settings layout
 * with an authentication guard.
 *
 * Unauthenticated users are redirected to sign-in via AuthGuard.
 */
